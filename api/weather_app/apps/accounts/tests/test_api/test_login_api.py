...
LOGIN_SERIALIZER_PATH = "weather_app.apps.accounts.api.v1.serializers.login.LoginSerializer"
...
def test_login_api_success(user_account, unauthorized_api_client, mocker):
    ...
    mocked_login = mocker.patch(
        "weather_app.apps.accounts.services.login.LoginService.login", return_value=mocked_response
    )
